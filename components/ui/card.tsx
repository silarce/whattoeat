...
function Card({ name, isSelected, disabled, onClick, onRemove }: WheelCardProps) {
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "relative w-full overflow-hidden rounded-xl border-2 px-3 py-3 text-center transition-all duration-150 cursor-pointer",
        ...
        isSelected
          ...
          : "border-gray-100 bg-gray-50 hover:border-orange-300 hover:bg-orange-50/50 dark:border-gray-700 dark:bg-gray-800 dark:hover:border-orange-600 dark:hover:bg-orange-950/50",
      )}
    >
      {onRemove && (
        <span
